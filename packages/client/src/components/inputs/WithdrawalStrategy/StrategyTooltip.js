...
export const StrategyTooltip = ({ type }) => {
    ...
    return (_jsxs("div", { className: "inline-block ml-2 leading-none", ref: iconRef, children: [_jsx(Info, { size: 14, className: `text-slate-400 hover:text-blue-600 transition-colors cursor-help ${isVisible ? 'text-blue-600' : ''}`, onMouseEnter: handleMouseEnter, onMouseLeave: () => setIsVisible(false) }), isVisible && (_jsxs("div", { className: "fixed w-80 p-5 bg-white border border-slate-200 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] z-[9999] pointer-events-none transition-all border-l-4 border-l-blue-500", style: {
                    left: '336px', // Sidebar (320px) + gap (16px)
                    top: `${top}px`,
                    transform: 'translateY(-20%)'
                }, children: [_jsxs("div", { className: "flex flex-col gap-3", children: [_jsx("p", { className: "text-[14px] font-bold text-slate-900 leading-tight", children: content.summary }), _jsx("p", { className: "text-[12px] text-slate-600 leading-relaxed", children: content.howItWorks }), _jsx("p", { className: "text-[11px] text-slate-400 italic font-medium pt-1 border-t border-slate-50", children: content.tradeoff })] }), _jsx("div", { className: "absolute top-4 -left-2 w-4 h-4 bg-white border-l border-t border-slate-200 rotate-[315deg]" })] }))] }));
};
